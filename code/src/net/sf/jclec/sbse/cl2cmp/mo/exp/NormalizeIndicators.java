...
public class NormalizeIndicators {
	...
	public NormalizeIndicators(String dirname, int nObjs){
	...
	public static void main(String[] args) {
		...
		//NormalizeIndicators obj = new NormalizeIndicators(args[0], Integer.parseInt(args[1]));
		String dirname = "G:\\Aurora\\Documentos\\Universidad\\KDIS\\revistas\\2014 Comparativa many\\experimentación\\rawdata\\6obj-3";
		int objs = 6;
		NormalizeIndicators obj = new NormalizeIndicators(dirname,objs);
		//obj.normalize();
		obj.indicators();
	}
			...
			for(File o: objDirs){
				...
				for(File p: probDirs){
					...
					try {
						...
						String name = o.getName()+"-emo-indicators2.xlsx";
