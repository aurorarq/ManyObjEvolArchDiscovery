...
public class NormalizeIndicators3 {
	...
	public NormalizeIndicators3(String dirname, int nObjs){
	...
	public static void main(String[] args) {
		...
		String dirname = "./";
		int objs = 9;
		NormalizeIndicators3 obj = new NormalizeIndicators3(dirname,objs);
		//obj.normalize();
		obj.indicators();
	}
			...
			//		System.out.println("\t"+p.getName());
					...
					for(File a: algDirs){
						...
						if(a.isDirectory()){
							...
							res2.getColumn(0).addValue(dir.getName()+"-"+a.getName());
