...
public class NormalizeIndicators4 {
	...
	public NormalizeIndicators4(String dirname, int nObjs){
	...
	public static void main(String[] args) {
		...
		String dirname = "./";
		int objs = 9;
		NormalizeIndicators4 obj = new NormalizeIndicators4(dirname,objs);
		//obj.normalize();
		obj.indicators();
	}
	...
	public void indicators(){
		...
		double [][] front;
		Dataset dataset, res = null, res2 = null;
		NumericalColumn col;
		...
		if(dir.exists()){
			...
			//		System.out.println("\t"+p.getName());
					//auxdirname = dir.getAbsolutePath() + this.resNormDirname;
					...
					//for(File a: algDirs){
						...
						//if(a.isDirectory()){
							...
							for(File f: fronts){
								...
								try {
									((ExcelDataset)res).writeDataset("emo-indicators"+k+".xlsx");
								} catch (IOException e) {
									e.printStackTrace();
								}
								k++;
							...
							try {
								((ExcelDataset)res).writeDataset("emo-indicators.xlsx");
							} catch (IOException e) {
								e.printStackTrace();
							}

							// Copy mean and standard deviation values in the second dataset
							res2.getColumn(0).addValue(dir.getName()+"-avg");
					...
					// Save res2 dataset
					try {
						//String path = dir.getAbsolutePath()+"/"+o.getName();
						String path = dir.getAbsolutePath()+"/";
						//String name = o.getName()+"-emo-indicators.xlsx";
						String name = dir.getName()+"-emo-indicators.xlsx";
						//String name = "moead-emo-indicators.xlsx";
